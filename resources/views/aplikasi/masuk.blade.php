...
@section('konten')
    <div class="nav">
        <h4 class="d-block mx-auto my-auto">Pindahan Masuk</h4>
    </div>
    <div class="input mt-4">
        <form action="/insertDataMasuk" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <br>
            <h5 class="mx-5" style="font-size: 16">Alamat asal :</h5>
